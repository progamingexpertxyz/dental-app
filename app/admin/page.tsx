        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse border border-gray-300 hidden md:table">
              <thead>
                <tr className="bg-gray-200 text-gray-900">
                  ...
                  <th className="border p-3">Treatment</th>
              ...
              <tbody>
                {appointments.map((appointment, index) => (
                  <tr key={appointment.id || index} className="hover:bg-gray-100 text-black">
                    ...
                    <td className="border p-3">{appointment.treatment}</td>
                    <td className="border p-3">{appointment.address}</td>
                    <td className="border p-3">{appointment.message}</td>
            ...
            <div className="md:hidden flex flex-col gap-4">
              {appointments.map((appointment, index) => (
                <div key={appointment.id || index} className="border p-4 rounded-lg bg-gray-50 shadow-md">
                  ...
                  <p className="text-sm"><span className="font-semibold">Treatment:</span> {appointment.treatment}</p>
                  <p className="text-sm"><span className="font-semibold">Address:</span> {appointment.address}</p>
                  <p className="text-sm"><span className="font-semibold">Message:</span> {appointment.message}</p>
                  <p className="text-sm"><span className="font-semibold">Service:</span> {appointment.service}</p>
                  <p className="text-sm"><span className="font-semibold">Status:</span> {appointment.status}</p>
